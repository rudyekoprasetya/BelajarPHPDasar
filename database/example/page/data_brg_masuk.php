...
<div class="row">
	...
	<form role="form" action="?page=page/data_brg_masuk" method="POST">
...
<div class="row">
	...
	<form method="POST" action="?page=page/simpan_brg_masuk">
		<h2 class="panel-heading"><i class="fa fa-sign-in"></i> Barang Masuk</h2>
